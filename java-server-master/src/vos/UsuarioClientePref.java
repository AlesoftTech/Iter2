...
public class UsuarioClientePref {
	...
	private Long preferenciaPrecio;
	
	public UsuarioClientePref(@JsonProperty(value = "id") Long id, @JsonProperty(value = "correo") String correo, 
			@JsonProperty(value = "rol") String rol, @JsonProperty(value = "infoRol") String infoRol, 
			@JsonProperty(value = "nombre") String nombre, @JsonProperty(value = "preferenciaPrecio")Long preferenciaPrecio){
		this.id = id; 
		this.correo = correo; 
		this.rol = rol; 
